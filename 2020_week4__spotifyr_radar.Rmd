...
#TODO: line thickness, geom_line(size = X) misses a few lines
anim <- ggRadar(data = plotdf, aes(group = year), size = 2, ylim = 1.02) +
  ...
  labs(title = "How music changes over time",
       subtitle = "An animation of different song metrics from 1970 to 2020. Variables have been \nnormalized to a 0 to 1 range.",
